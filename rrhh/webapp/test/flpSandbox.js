		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#proyectofinalrrhh-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"proyectofinalrrhh-display": {
								"semanticObject": "proyectofinalrrhh",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=proyectofinal.rrhh",
									"url": sap.ui.require.toUrl("proyectofinal/rrhh")
								}
							}
						}
					}
